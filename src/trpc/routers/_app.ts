...
export const appRouter = createTRPCRouter({
  getUsers: baseProcedure // basically api call
    // .input( // request body
    ...
    //   }),
    // )
    .query((opts) => { // .query acts like GET handler. Receives validated input in opts.input and returns {greeting: `hello {opts.input.text}`}
